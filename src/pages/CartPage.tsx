                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center justify-between mt-3">
                        ...
                        <p className="font-bold text-[#333333]">{formatPrice(item.price * item.quantity)}</p>
                      </div>
                    </div>
                  </div>
                ))}
                ...
                <div className="bg-white rounded-2xl border border-gray-100 p-6 sticky top-28">
                  ...
                  <div className="space-y-3 mb-6">
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="font-semibold text-[#333333]">{formatPrice(cartTotal)}</span>
                    </div>
                    <div className="flex justify-between text-sm">
                    ...
                    <div className="border-t border-gray-100 pt-3 flex justify-between">
                      ...
                      <span className="font-bold text-lg text-[#333333]">{formatPrice(cartTotal)}</span>
                    </div>
                  </div>
